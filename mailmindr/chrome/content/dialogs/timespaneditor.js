...
mailmindr.dialogs.timeSpanEditor = {
    ...
    getString: function(identifier) {
        var source = document.getElementById('mailmindrTimespaneditorStrings');
        return source.getString(identifier);
    },

    _createTimespan: function() {
        let ts = {
            id: 0,
            text: '',
            days: 0,
    ...
    getAutoName: function() {
        ...
        return mailmindrCommon.capitalize(current.toRelativeString());
    },
