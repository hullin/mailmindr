...
mailmindr.dialogs.mindralert = {
    ...
    Initialize: function() {
        if (!this._initialized) {
            ...
            */
            ...
            // this._openMessageFunction = window.arguments[0].openMessageFunction;
    ...
    setEventListeners: function() {
        ...
        var onPushMindrs = {
            observe : function(aSubject, aTopic, aData) {
                ...
                // scope._listView.updateItems(mindrs);
  ...
  //                           document.getElementById("tabmail"));
            // var threePaneWindow = mailmindrKernel.kernel.modules
            //                         .common.getWindow("mail:3pane"); //.msgWindow; 

            // threePaneWindow.MsgDisplayMessageInFolderTab(messageHeader);
            return;

            var lFolderDisplay = threePaneWindow.gFolderDisplay;
            this._logger.warn('folderDisplay: ' + lFolderDisplay);
            MailUtils.displayMessage(messageHeader.hdr, lFolderDisplay.view,
                            threePaneWindow.msgWindow.document.getElementById("tabmail"));
        } catch (e) {
