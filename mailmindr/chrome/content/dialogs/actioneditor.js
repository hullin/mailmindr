...
mailmindr.dialogs.actioneditor = {
    ...
    Initialize: function() {
        ...
        if (!this._initialized) {
            ...
            this._elements.folders = document.getElementById("mailmindrTargetFolder");
            this._elements.editorFields = document.getElementById("mailmindrActionEditorEditfields");
            this._elements.checkTagAction = document.getElementById("mailmindrCheckTagAction");
            this._elements.checkFolderAction = document.getElementById("mailmindrCheckFolderAction");
            this._elements.checkDoShowDialog = document.getElementById("mailmindrCheckDoShowDialog");
            this._elements.checkDoMarkAsUnread = document.getElementById("mailmindrCheckDoMarkAsUnread");
            this._elements.checkDoMarkFlag = document.getElementById("mailmindrCheckDoMarkFlag");
            this._elements.radioDoMove = document.getElementById("mailmindrDoMove");
            this._elements.radioDoCopy = document.getElementById("mailmindrDoCopy");

            this._elements.editorFields.setAttribute('hidden', !options.standalone ? 'false' : 'true');
    ...
    setEventListeners: function() {
        ...
        if (this._elements.checkTagAction) {
            this._elements.checkTagAction.addEventListener('CheckboxStateChange', function(e) {
                scope.onTriggerChange("mailmindrCheckTagAction");
            });
        }

        if (this._elements.checkFolderAction) {
            this._elements.checkFolderAction.addEventListener('CheckboxStateChange', function(e) {
...
window.addEventListener("load", function() {
    // mailmindr.dialogs.actioneditor = new mailmindrActioneditor();
